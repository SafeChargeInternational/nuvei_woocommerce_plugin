...
<div id="nuvei_plan_attr_terms">
	...
	<div class="form-field term-group">
		...
		<select name="planId" id="planId" required="" onchange="nuveiFillPlanData(this.value)">
			<option value="">
				<?php echo esc_html__('Select a Plan...', 'nuvei_woocommerce'); ?>
			</option>
	...
	<div class="form-field term-group">
		...
		<select name="recurringPeriodUnit" id="recurringPeriodUnit" class="nuvei_units">
			...
			<option value="month"><?php echo esc_html__('Month', 'nuvei_woocommerce'); ?></option>
			<option value="year"><?php echo esc_html__('Years', 'nuvei_woocommerce'); ?></option>
		</select>
